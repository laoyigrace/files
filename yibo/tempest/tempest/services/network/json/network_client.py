...
class NetworkClient(service_client.ServiceClient):
    ...
    def _update_router(self, router_id, set_enable_snat, **kwargs):
        ...
        update_body['enable_dns_proxy'] = kwargs.get('enable_dns_proxy', body['router']['enable_dns_proxy'])
        update_body['nameservers'] = kwargs.get('nameservers', body['router']['nameservers'])
