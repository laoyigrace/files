...
class ServersClient(service_client.ServiceClient):
    ...
    # NOTE(dxp): add cpu and ram
    # Note(fty):add description
    def update_server(self, server_id, name=None, meta=None, accessIPv4=None,
                      accessIPv6=None, disk_config=None, cpu=None, ram=None,
                      desc=None):
        """
    ...
    def create_attach_volume(self, server_id, **kwargs):
        """create and attaches a volume to a server instance."""
        return self.action(server_id, 'create_attach_volume', None, **kwargs)

    def attach_detach_volumes(self, server_id, **kwargs):
        """create and attaches a volume to a server instance."""
        return self.action(server_id, 'attach_detach_volumes', None, **kwargs)
