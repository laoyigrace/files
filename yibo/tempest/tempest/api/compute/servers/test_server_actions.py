...
class ServerActionsTestJSON(base.BaseV2ComputeTest):
    ...
    # NOTE(dxp): modify by sangfor
    @decorators.skip_because(bug='43569')
    ...
    # NOTE(dxp): modified by sangfor. sangfor not support
    @decorators.skip_because(bug="43569")
    ...
    # NOTE(dxp): add smoke, and delete xvpvnc
    @test.attr(type='smoke')
