...
from tempest.services.compute.json.sf_servers_client import SfServersClient
...
from tempest.services.network.json.sf_network_client import SfNetworkClient
from tempest.services.identity.v2.json.sf_identity_client import SfIdentityClient

# by hct
from tempest.services.vsan.json.vsan_client import VsanClient
...
class Manager(manager.Manager):
    ...
    def __init__(self, credentials=None, service=None):
        ...
        self.network_client = NetworkClient(
            ...
            **self.default_params)
        self.sf_network_client = SfNetworkClient(
            self.auth_provider,
            CONF.network.catalog_type,
            CONF.network.region or CONF.identity.region,
            endpoint_type=CONF.network.endpoint_type)
    ...
    def _set_compute_clients(self):
        ...
        self.certificates_client = CertificatesClient(self.auth_provider,
                                                      **params)
        self.servers_client = SfServersClient(
            self.auth_provider,
    ...
    def _set_identity_clients(self):
        ...
        self.identity_client = IdentityClient(self.auth_provider,
                                              **params)
        self.sf_identity_client = SfIdentityClient(self.auth_provider,
                                                   **params)
    ...
    def _set_vsan_client(self):
        params = {
            'service': CONF.vs.catalog_type,
            'region': CONF.vs.region or CONF.identity.region,
            'endpoint_type': CONF.vs.endpoint_type
        }
        params.update(self.default_params)
        self.vsan_client = VsanClient(self.auth_provider,**params)
