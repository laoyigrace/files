...
# by hct
class ClusterBuildErrorException(TempestException):
    message = "Cluster %(cluster_id)s failed to build and is in ERROR status"

class ClusterReplaceErrorException(TempestException):
    message = "Cluster %(cluster_id)s failed to replace disk and is in ERROR status"

class ClusterExpandErrorException(TempestException):
    message = "Cluster %(cluster_id)s failed to expand and is in ERROR status"

class ClusterDeleteErrorException(TempestException):
    message = "Cluster %(cluster_id)s failed to delete and is in ERROR status"
